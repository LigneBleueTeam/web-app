...
<div class="card">
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <label>Temps</label>
              <input id="time" type="text" class="form-control" value="{{ $data->time }}">
            </div>
          </div>
        </div>
        <div class="row">
        ...
        <div id="successdiv" class="su alert-success alert-dismissible" style="display:none;">
          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
          <h5><i class="icon fas fa-exclamation-triangle"></i> L'activité a bien été modifiée.</h5>
        </div>
        <input hidden id="activityId" type="text" class="form-control" value="{{ $data->activityId }}">
</div>
